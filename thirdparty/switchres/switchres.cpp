...
switchres_manager::switchres_manager()
{
	...
	// The post-increment form passed 1..MAX_RANGES, leaving range 0
	// uninitialised and writing one element past crt_range[] into the
	// lcd_range field that follows it.
