...
{
	// parse_options() passes m_ds.monitor back in, so source and destination
	// can be the same buffer; strncpy is undefined for overlapping ranges and
	// aborts under fortified libc builds.
	if (preset != m_ds.monitor)
